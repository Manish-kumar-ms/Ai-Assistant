...
const SignIn = () => {
  ...
  return (
    ...
    >
      <form onSubmit={handleSignIn} className="w-[90%] h-[600px] max-w-[500px] px-[20px] bg-[#00000062] backdrop-blur shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] ">
        ...
        <button className="min-w-[150px] mt-[30px] h-[60px] flex items-center justify-center bg-white text-[19px] text-black font-semibold rounded-full" disabled={loading}>
          {loading ? <AiOutlineLoading3Quarters className="animate-spin" /> : "Sign In"}
        </button>
        <p className="text-white text-[18px]">
          want to create an new account?{" "}
          <span onClick={() => navigate("/signup")} className="text-blue-400">
            Sign Up
          </span>
        </p>
      </form>
